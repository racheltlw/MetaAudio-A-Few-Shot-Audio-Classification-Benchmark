...
Each instantiation:
    ...
    -> Overide some variables in the params dictionary loaded from maml_params.yaml
...
Other changes:
    -> Made it so that all model patrams in one file, and the ones that are run
        is determined by an array passed in from the main params control file
"""
###############################################################################
# IMPORTS
###############################################################################
...
from MAML_Main import main as single_run_main
