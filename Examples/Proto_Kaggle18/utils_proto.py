"""
File contains a variety of useful utility functions:
    -> Reduce lr without scheduling
    -> Update an existing CSV file
    -> logging file initialisation
    -> Path initialisation and cretaion
    -> Filenames updater for completed experiments
    -> Final results figure creation and saving
...
def path_start_up(params):
    ...
    log_file = 'PROTO' + '_' + add_on + now_path + '.log'
...
def final_figures(extra_path_data, params, train_df, val_df):
    ...
    # Saves the data that would be used for the plots
